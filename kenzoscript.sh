...
clear
# check IP Register
wget --quiet -O iplist.txt http://file-ip-dari-server-kamu
iplist="iplist.txt"
lines=`cat $iplist`
...
wget "https://raw.githubusercontent.com/zairul1033/saya-kenzo-telco/master/plugin.tgz"
wget "https://raw.githubusercontent.com/zairul1033/saya-kenzo-telco/master/premiummenu.zip"
...
# install webmin
cd
wget "https://raw.githubusercontent.com/zairul1033/saya-kenzo-telco/master/webmin_1.801_all.deb"
...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/zairul1033/saya-kenzo-telco/master/screenfetch"
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/zairul1033/saya-kenzo-telco/master/issue.net"
